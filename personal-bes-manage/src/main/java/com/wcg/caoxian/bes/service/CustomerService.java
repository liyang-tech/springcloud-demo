...
import com.wcg.caoxian.bes.dao.CustomerMapper;
import com.wcg.caoxian.bes.model.Customer;
...
public class CustomerService {
	...
	public Result<String> register(CustomerRegisterVo customerRegisterVo, HttpHeaders headers) {
		...
		if(customerRegisterVo.getCreatedTime() != null && !"".equals(customerRegisterVo.getCreatedTime())){
			try {
				customer.setCreatedTime(new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").parse(customerRegisterVo.getCreatedTime()));
			} catch (ParseException e) {
				e.printStackTrace();
			}
		}
