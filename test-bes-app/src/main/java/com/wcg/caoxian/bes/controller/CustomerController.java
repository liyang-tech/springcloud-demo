...
public class CustomerController {
	...
	public Result<String> registerCustomer(@RequestBody CustomerRegisterVo customerRegisterVo, @RequestHeader HttpHeaders headers){
		Result<String> result = customerService.registerCustomer(customerRegisterVo, headers);
		return result;
	}
	 ...
	 * @author 李洋  liyang
	 * @data 2017年9月8日 下午5:52:01
	 * @return Result<List<CustomerOutParamVo>>
	 */
	@ApiOperation(value = "根据查询条件获取客户信息", notes = "根据查询条件获取客户信息")
	@ApiImplicitParams({
	...
	public Result<List<CustomerOutParamVo>> searchCustomer(CustomerInputParamVo customerInputParamVo, PageBean pageBean, @RequestHeader HttpHeaders headers){
		Result<List<CustomerOutParamVo>> result = customerService.searchByCondition(customerInputParamVo, pageBean, headers);
		return result;
	}
	 ...
	 * @return Result<String>
	 */
	@ApiOperation(value = "BES0230-客户信息修改", notes = "根据客户编码修改客户信息")
	@ApiImplicitParams({
	 ...
	 * @return Result<String>
	 */
	@ApiOperation(value = "BES0240-客户信息删除", notes = "根据客户编码删除客户信息")
	@ApiImplicitParams({
	 ...
	 */
	@ApiOperation(value = "BES0250-客户单记录查询", notes = "根据客户编码查询客户信息")
	@ApiImplicitParams({
		@ApiImplicitParam(name = "code", value = "客户编码", required = true, dataType = "String", paramType = "path"),
		@ApiImplicitParam(name = "TK_BUSINESS_SERIALID", value = "交易流水", required = false, dataType = "String", paramType = "header"),
		@ApiImplicitParam(name = "TK_REQUEST_SYS_CODE", value = "请求方系统编码", required = false, dataType = "String", paramType = "header"),
	...
	public Result<CustomerOutParamVo> searchOneCust(@PathVariable String code, @RequestHeader HttpHeaders headers){
		Result<CustomerOutParamVo> result = customerService.searchOneCust(code, headers);
		return result;
	}
