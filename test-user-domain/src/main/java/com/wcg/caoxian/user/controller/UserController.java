...
import com.wcg.caoxian.user.service.UserService;
import com.wcg.caoxian.user.vo.UserLoginInputVo;
import com.wcg.caoxian.user.vo.UserLoginOutVo;
import com.wcg.caoxian.user.vo.UserReAndUpVo;
import com.wcg.caoxian.user.vo.UserSearchInputParamVo;
import com.wcg.caoxian.user.vo.UserSearchOutParamVo;
...
@Api(description="用户管理领域服务的API接口")
